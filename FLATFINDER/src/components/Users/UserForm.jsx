...
const UserForm = ({ userId = null }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    password: userId ? Yup.string().min(6, 'Password must be at least 6 characters') : Yup.string().min(6, 'Password must be at least 6 characters').required('Password is required'),
